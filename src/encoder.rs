...
mod test {
    ...
    fn test_data_assembly() {
        ...
        let data = assemble_qr_data("Hello, world! 123", ErrorCorrection::Low);
        let expected = [
            0x41, 0x14, 0x86, 0x56, 0xC6, 0xC6, 0xF2, 0xC2, 0x07, 0x76, 0xF7, 0x26, 0xC6, 0x42,
            0x12, 0x03, 0x13, 0x23, 0x30, 0x85, 0xA9, 0x5E, 0x07, 0x0A, 0x36, 0xC9,
        ];
        assert_eq!(data, expected);
